...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		try {
          ...
          //loadFoodButton.setOnAction(e -> )///METHOD FOR ADDING FOOD FILE TO FOOD LIST
			...
			*/
			/*
			if (nutrientFilter.equals("")) {
				//addFilterButton.setOnAction(e -> Filters.activateNameFilter(nameFilter));
				addFilterButton.setOnAction(e-> { Alert buttonAlert3 = new Alert(AlertType.WARNING, "is this what you want?["+nutrientFilter+"]");
			...
			*/
            ...
            /*addNameFilterButton.setOnAction(a -> filtersList.getItems().add(nameFilterInputBox.getText()));
            addNameFilterButton.setOnAction(f -> nameFilterInputBox.clear());
